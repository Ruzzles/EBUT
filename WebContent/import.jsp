...
<p><br><a href="<%= response.encodeURL("controllerservlet?action="+Constants.ACTION_IMPORT) %>"><img alt="Refresh" title="Import" border="0" src="images/buttons/import.png">&nbsp;Import</a></p>
</body>
</html>
